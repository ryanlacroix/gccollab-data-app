  ...
  render() {
    return (
      <div className="App" style={{/*backgroundImage: "url(https://gccollab.ca//mod/gc_splash_page_collab/graphics/Peyto_Lake-Banff_NP-Canada.jpg)",*/backgroundColor: '#f9f9f9', height: "100%", maxWidth: '100%', align: "center"}}>
        <div id="lang-toggle">
            <a id="eng-toggle" class="lang" onClick={() => this.state.groupURL == "" ? this.setState({helpmessage: "Paste the group URL above and set your desired start and end dates to retrieve relevant statistics.", initLang: "EN", title: "GCcollab Group Stats Page", language: "EN"}) : this.setState({language: "EN"})}>en</a> | <a id="fr-toggle" class="lang" onClick={() => this.state.groupURL == "" ? this.setState({initLang: "FR", helpmessage: "Collez l'URL du groupe ci-dessus et choisissez les dates de début et de fin pour récupérer les statistiques pertinentes.", title: "Page des statistiques des groupes GCcollab", language: "FR"}) : this.setState({language: "FR"})}>fr</a>
        </div>
